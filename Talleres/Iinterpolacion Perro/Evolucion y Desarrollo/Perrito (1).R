...
plot(x,y,  pch = 19, cex=0.5,xlim=c(0,31),ylim=c(0,10))

x1=x[1:4]
y1=y[1:4]
polyAjuste1 = poly.calc(x1,y1)
curve(polyAjuste1,from=1,to=6,add=T, lwd=1,col=2)

x2=x[4:6]
y2=y[4:6]
polyAjuste2 = poly.calc(x2,y2)
curve(polyAjuste2,from=6,to=8.1,add=T, lwd=1,col=2)

x3=x[6:9]
y3=y[6:9]
polyAjuste3 = poly.calc(x3,y3)
curve(polyAjuste3,from=8.1,to=17.6,add=T, lwd=1,col=2)

x4=x[9:12]
y4=y[9:12]
polyAjuste4 = poly.calc(x4,y4)
curve(polyAjuste4,from=17.6,to=24.5,add=T, lwd=1,col=2)

x5=x[12:15]
y5=y[12:15]
polyAjuste5 = poly.calc(x5,y5)
curve(polyAjuste5,from=24.5,to=27.5,add=T, lwd=1,col=2)

x6=x[15:18]
y6=y[15:18]
polyAjuste6 = poly.calc(x6, y6)
