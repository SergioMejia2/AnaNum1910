...
lines(spline(x[1:12], y[1:12], n = 201), col = dog_c,xlim=c(0,31),ylim=c(0,9))
lines(spline(x[12:29], y[12:29], n = 201), col = dog_c,xlim=c(0,31),ylim=c(0,9))
op = 0
op = (26*length(x[1:12])-32) + (26*length(x[12:29])-32)
